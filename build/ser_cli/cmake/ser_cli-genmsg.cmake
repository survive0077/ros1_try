...
get_filename_component(_filename "/home/yxj/code/ros1_try/src/ser_cli/srv/addints.srv" NAME_WE)
add_custom_target(_ser_cli_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ser_cli" "/home/yxj/code/ros1_try/src/ser_cli/srv/addints.srv" ""
)
...
_generate_srv_cpp(ser_cli
  "/home/yxj/code/ros1_try/src/ser_cli/srv/addints.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ser_cli)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ser_cli\")")
  # install generated code
  install(
